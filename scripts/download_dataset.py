...
class GoEmotionsLoader:
    ...
    def save_processed_data(self, data: dict[str, pd.DataFrame]) -> None:
        ...
        mapping = {
            ...
            "emotion_to_idx": {
                emotion: i for i, emotion in enumerate(self.mlb.classes_)
            },
        }
    ...
    def get_emotion_statistics(self, data: dict[str, pd.DataFrame]) -> dict[str, Any]:
        ...
        for split, df in data.items():
            emotion_cols = [
                ...
                and col != "emotion_labels"
                and col != "emotion_count"
            ]
    ...
    def run_pipeline(self) -> dict[str, pd.DataFrame]:
        ...
        for split, split_stats in stats.items():
            ...
            print(
                f"  Avg emotions per sample: {split_stats['avg_emotions_per_sample']:.2f}"
            )
